...
Public Class CompraVenta
    ...
    Private Sub CompraVenta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ObtenerRegistros("", "")
    End Sub
    ...
    Private Sub ObtenerRegistros(ByVal empresa As String, ByVal periodo As String)
        Try
            ...
            dsregistros = oContratoRO.LeerListaToDSContable_CompraVenta
