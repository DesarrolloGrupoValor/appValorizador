...
Public Class ReporteCompraVenta
    'control de errores
    ...
    Private Sub ReporteCompraVenta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Try
            Me.WindowState = FormWindowState.Maximized
            fxgrdComprasVentas.AutoGenerateColumns = False
            fxgrdComprasVentas.AllowFreezing = C1.Win.C1FlexGrid.AllowFreezingEnum.Both
    ...
    Private Sub ObtenerPeriodos()
        ...
        dsPeriodo = oBC_PeriodoRO.ObtenerPeriodo()
        cboPeriodoFin.DataSource = dsPeriodo.Tables(0)
        cboPeriodoFin.DisplayMember = "periodo"
        cboPeriodoFin.ValueMember = "periodoId"
    ...
    Private Sub ObtenerRegistros()
        Try
            ...
            oReporteCompraVentaRO.oBEReporteCompraVenta.periodoFin = cboPeriodoFin.SelectedValue
    ...
    Private Sub tsbConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TsbConsultar.Click
        ...
        Try
            ...
            If cboPeriodo.SelectedIndex < 1 Then
                MsgBox("Debe seleccionar periodo inicio", MsgBoxStyle.Exclamation, "Valorizador de Minerales")
                Return
            End If

            If cboPeriodoFin.SelectedIndex < 1 Then
                MsgBox("Debe seleccionar periodo fin", MsgBoxStyle.Exclamation, "Valorizador de Minerales")
                Return
            End If

            If cboPeriodoFin.SelectedIndex > cboPeriodo.SelectedIndex Then
                MsgBox("El período inicio debe ser menor al período fin", MsgBoxStyle.Exclamation, "Valorizador de Minerales")
                Return
            End If
