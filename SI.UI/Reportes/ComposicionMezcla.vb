...
Public Class ComposicionMezcla
    'control de errores
    ...
    Private Sub ObtenerRegistros(ByVal empresa As String, ByVal periodo As String)
        Try
            ...
            'dsregistros = oContratoRO.LeerListaToDSComposicionMezcla
            ...
            ''Dim psurl As String '= lsPagina + "ReportViewer.aspx?%2fVCM%2fCOMERCIAL%2f" & "Comercial_ComposicionMezcla" & "&rs:Command=Render" & sParametros



            ''sParametros = "&usuario=" & pBEUsuario.descri & "&empresa=&periodo="
            ''psurl = lsPagina + "ReportViewer.aspx?%2fVCM%2fCOMERCIAL%2f" & "Comercial_ComposicionMezcla" & "&rs:Command=Render" & sParametros
            ...
            oProcedimientos.ConfigurationReporting("Comercial_ComposicionMezcla", rptReportViewer, parameters)
