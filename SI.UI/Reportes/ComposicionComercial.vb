...
Public Class ComposicionComercial
    'control de errores
    ...
    Private Sub ObtenerRegistros(ByVal empresa As String, ByVal periodo As String)
        Try
            ...
            ''dsregistros = oContratoRO.LeerListaToDSComposicionComercial
            ...
            ''Dim psurl As String = lsPagina + "ReportViewer.aspx?%2fVCM%2fCOMERCIAL%2f" & "Comercial_ComposicionCom" & "&rs:Command=Render" & sParametros
            ...
            oProcedimientos.ConfigurationReporting("Comercial_ComposicionCom", rptReportViewer, parameters)
