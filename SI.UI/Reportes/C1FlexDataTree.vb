...
<ToolboxBitmap(GetType(C1FlexDataTree))> _
...
#Region "** overrides"
    ...
    Protected Overloads Overrides Sub OnBeforeMouseDown(ByVal e As BeforeMouseDownEventArgs)
        ...
        If e.Button <> Windows.Forms.MouseButtons.Left OrElse _colChild Is Nothing Then
            Return
        End If
    ...
    Protected Overloads Overrides Sub OnScroll(ByVal sb As ScrollBars)
        ...
        If sb <> System.Windows.Forms.ScrollBars.Horizontal Then
            UpdateChildren()
        End If
    End Sub
    ...
    Protected Overloads Overrides Sub OnGridChanged(ByVal sender As Object, ByVal e As GridChangedEventArgs)
        ...
        If e.GridChangedType = GridChangedTypeEnum.GridChanged OrElse e.GridChangedType = GridChangedTypeEnum.RowAdded OrElse e.GridChangedType = GridChangedTypeEnum.RowRemoved Then
            UpdateChildren()
        End If
    End Sub
