...
#End Region
    ...
    Private Sub tsbAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbAceptar.Click
        ...
        If sValidacion = "" Then
            ...
            oTB_DIG_INDICE.ARCHIVO = txtNRO_DOC_EXTERNO.Text + sExtension
            ...
            oTB_DIG_INDICE.NRO_DOC_EXTERNO = txtNRO_DOC_EXTERNO.Text
    ...
    Private Sub txtBENEFICIARIO_ID_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        obtenerBeneficiario()
    End Sub
